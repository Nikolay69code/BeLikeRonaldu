...
import com.example.belikeronaldu.Adapter.NotesListAdapter;
import com.example.belikeronaldu.DataBase.RoomDB;
        ...
        float_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Toast.makeText(GoalsActivity.this, "Произошла ошибка при нажатии на кнопку", Toast.LENGTH_LONG).show();
                }
            }
        });

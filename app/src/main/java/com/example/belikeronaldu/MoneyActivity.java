    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonminus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    if(editt.isEmpty()){
                        Toast.makeText(MoneyActivity.this, "Ты не ввёл сумму?", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    sPref = getPreferences(MODE_PRIVATE);
                    ...
                    Toast.makeText(MoneyActivity.this, "Я надеюсь они были потрачены с пользой", Toast.LENGTH_LONG).show();
                    Thread thread = new Thread(){
                        @Override
                        public void run(){
                            progressBar.setMax(bugatti);
        ...
        buttonplus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    thread.start();
                    Toast.makeText(MoneyActivity.this, "Ты еще на один шаг ближе к Бугатти!", Toast.LENGTH_LONG).show();
                }catch (Exception e){
                    if(editt.isEmpty()){
                        Toast.makeText(MoneyActivity.this, "Ты не ввёл сумму?", Toast.LENGTH_SHORT).show();
                        return;
